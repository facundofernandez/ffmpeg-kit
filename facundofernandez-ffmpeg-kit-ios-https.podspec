...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/facundofernandez/ffmpeg-kit"
  ...
  s.source       = { :http => "https://github.com/facundofernandez/ffmpeg-kit/releases/download/v6.0.2-facundofernandez/ffmpeg-kit-https-6.0-ios-xcframework.zip"}
